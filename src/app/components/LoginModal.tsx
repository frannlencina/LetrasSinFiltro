...
export default function LoginModal({ onClose }) {
    return ReactDOM.createPortal(
        <div className='fixed flex justify-center items-center w-screen h-screen top-0 left-0 bg-black bg-opacity-80 z-40'>
            ...
            <div className='w-full flex justify-end'><button onClick={onClose} className='text-xl font-bold text-red-700'><i className="ri-close-line"></i></button></div>
                <div className='flex flex-col sm:flex-row items-center justify-center '>
                    <Image src='/memoji-triste2.png' width={80} height={80} alt='' />
                    <h1 className='text-xl text-center  sm:text-2xl text-blue-400 font-bold sm:text-start ml-4 pointer-events-none select-none'>Para utilizar esta funcion, tienes que estar logeado</h1></div>
