      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        {
          favoriteCards.map((card, index) => (
            <div className="flex flex-col justify-center items-center gap-2  scale-75 select-none">
              <div id={`elementToDownload-` + card.id} className="scale-100">
              ...
              <div className="flex justify-center gap-8 items-center text-3xl">
                ...
                <button onClick={() => removeFavoriteCard(card.id)} className="text-red-600 opacity-50 hover:opacity-100 transition-all">
