export default function AboutUs() {
    ...
    const aboutCards =
    {
        ...
        "Contacto": {
            description: "Puedes ponerte en contacto con nosotros a través de nuestro correo electrónico letrassinfiltro@gmail.com o enviándonos un mensaje a través de nuestras redes sociales."
        },
        "Donacion": {
    ...
    return (
        <main className="w-full h-full flex flex-col justify-center items-center mt-48">
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-12 p-4 sm:p-12 max-w-6xl">
                {
                    Object.entries(aboutCards).map(([title, info], index) =>
                        <article key={index} className="max-w-2xl border rounded-xl p-4 pointer-events-none">
